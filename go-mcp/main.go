// Command ForeignExchangeRates-mcp is an MCP server exposing the ForeignExchangeRates
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ForeignExchangeRates_list  — list records of an entity
//	ForeignExchangeRates_load  — load a single record of an entity
//
