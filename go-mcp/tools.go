...
type Args struct {
	Entity string         `json:"entity" jsonschema:"account | convert | currency | range | rate"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ForeignExchangeRatesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "foreign-exchange-rates_list",
		Description: "List records from ForeignExchangeRates. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "foreign-exchange-rates_load",
		Description: "Load a single record from ForeignExchangeRates. " +
...
func runOp(client *sdk.ForeignExchangeRatesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ForeignExchangeRatesSDK, name string) (sdk.ForeignExchangeRatesEntity, error) {
