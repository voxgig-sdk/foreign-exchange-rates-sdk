...
from foreignexchangerates_sdk.utility import register

# Load features
from foreignexchangerates_sdk.feature.base_feature import ForeignExchangeRatesBaseFeature
from foreignexchangerates_sdk.features import _has_feature, _make_feature
...
class ForeignExchangeRatesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ForeignExchangeRatesUtility()
    ...
    def get_utility(self):
        return ForeignExchangeRatesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ForeignExchangeRatesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Account(self, data=None) -> "AccountEntity":
        ...
        from foreignexchangerates_sdk.entity.account_entity import AccountEntity
    ...
    def Convert(self, data=None) -> "ConvertEntity":
        ...
        from foreignexchangerates_sdk.entity.convert_entity import ConvertEntity
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from foreignexchangerates_sdk.entity.currency_entity import CurrencyEntity
        return CurrencyEntity(self, data)


    def Range(self, data=None) -> "RangeEntity":
        """Entity factory: client.Range().list() / client.Range().load({"id": ...})."""
        from foreignexchangerates_sdk.entity.range_entity import RangeEntity
        return RangeEntity(self, data)


    def Rate(self, data=None) -> "RateEntity":
        """Entity factory: client.Rate().list() / client.Rate().load({"id": ...})."""
        from foreignexchangerates_sdk.entity.rate_entity import RateEntity
        return RateEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ForeignExchangeRatesSDK":
        if sdkopts is None:
            sdkopts = {}
