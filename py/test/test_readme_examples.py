# ForeignExchangeRates SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ForeignExchangeRatesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ForeignExchangeRatesSDK(...) and ForeignExchangeRatesSDK.test(...) become
#      ForeignExchangeRatesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "foreignexchangerates_sdk"
_SDK_CLASS = "ForeignExchangeRatesSDK"
