...
|---|---|---|
| `ts/` | @voxgig-sdk/foreign-exchange-rates-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/foreign-exchange-rates-sdk \
      --repository voxgig-sdk/foreign-exchange-rates-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/foreign-exchange-rates-sdk` shows it, and
`npm trust revoke @voxgig-sdk/foreign-exchange-rates-sdk --id=<id>` removes it.
