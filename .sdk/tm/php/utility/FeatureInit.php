...
// ForeignExchangeRates SDK utility: feature_init

class ForeignExchangeRatesFeatureInit
{
    public static function call(ForeignExchangeRatesContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
