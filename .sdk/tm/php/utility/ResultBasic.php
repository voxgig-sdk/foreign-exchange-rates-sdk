...
// ForeignExchangeRates SDK utility: result_basic

class ForeignExchangeRatesResultBasic
{
    public static function call(ForeignExchangeRatesContext $ctx): ?ForeignExchangeRatesResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof ForeignExchangeRatesError) ? $result->err->msg : (string)$result->err;
