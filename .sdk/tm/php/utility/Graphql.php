...
// ForeignExchangeRates SDK utility: graphql
//
...
class ForeignExchangeRatesGraphql
{
    ...
    // equivalent.
    public static function body(ForeignExchangeRatesContext $ctx): mixed
    {
    ...
    public static function errors(ForeignExchangeRatesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
