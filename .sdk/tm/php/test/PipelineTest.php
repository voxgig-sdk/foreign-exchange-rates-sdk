...
// ForeignExchangeRates SDK pipeline test
//
...
{
    private static function utility(): ForeignExchangeRatesUtility
    {
        return new ForeignExchangeRatesUtility();
    }
    ...
    private static function ctx(array $over = []): ForeignExchangeRatesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ForeignExchangeRatesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ForeignExchangeRatesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ForeignExchangeRatesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ForeignExchangeRatesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ForeignExchangeRatesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForeignExchangeRatesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ForeignExchangeRatesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ForeignExchangeRatesResponse([]),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        [, $err] = ForeignExchangeRatesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec([]),
            'response' => null,
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        [, $err] = ForeignExchangeRatesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec(['step' => 's']),
            'response' => new ForeignExchangeRatesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        [, $err] = ForeignExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec(['step' => 's']),
            'response' => new ForeignExchangeRatesResponse(self::resp(200, ['v' => 1])),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        [, $err] = ForeignExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec(['step' => 's']),
            'response' => new ForeignExchangeRatesResponse(self::resp(200, ['v' => 2])),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ForeignExchangeRatesMakeResponse::call($ctx);
    ...
    {
        $preset = new ForeignExchangeRatesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec([]),
            'response' => new ForeignExchangeRatesResponse([]),
            'result' => new ForeignExchangeRatesResult([]),
        ...
        [$got, $err] = ForeignExchangeRatesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ForeignExchangeRatesResult([])]);
        [, $err] = ForeignExchangeRatesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ForeignExchangeRatesSpec([]), 'result' => null]);
        [, $err] = ForeignExchangeRatesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForeignExchangeRatesSpec(['step' => 's']),
            'result' => new ForeignExchangeRatesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForeignExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ForeignExchangeRatesSpec(['step' => 's']),
            'result' => new ForeignExchangeRatesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ForeignExchangeRatesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ForeignExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ForeignExchangeRatesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ForeignExchangeRatesSpec([]),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ForeignExchangeRatesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForeignExchangeRatesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ForeignExchangeRatesError('boom', 'boom');
        $utility->fetcher = function (ForeignExchangeRatesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForeignExchangeRatesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ForeignExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ForeignExchangeRatesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ForeignExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ForeignExchangeRatesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ForeignExchangeRatesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ForeignExchangeRatesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ForeignExchangeRatesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ForeignExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ForeignExchangeRatesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ForeignExchangeRatesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ForeignExchangeRatesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ForeignExchangeRatesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ForeignExchangeRatesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ForeignExchangeRatesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ForeignExchangeRatesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ForeignExchangeRatesResult(['ok' => false])]);
        $this->expectException(ForeignExchangeRatesError::class);
        ForeignExchangeRatesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ForeignExchangeRatesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ForeignExchangeRatesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ForeignExchangeRatesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ForeignExchangeRatesBaseFeature();
        $b = new ForeignExchangeRatesBaseFeature();
        ForeignExchangeRatesFeatureAdd::call($ctx, $a);
        ForeignExchangeRatesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ForeignExchangeRatesBaseFeature
    {
        $f = new ForeignExchangeRatesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ForeignExchangeRatesFeatureAdd::call($ctx, self::named_feature('a'));
        ForeignExchangeRatesFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        ForeignExchangeRatesFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        ForeignExchangeRatesFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        ForeignExchangeRatesFeatureAdd::call($ctx, $replace);
        ...
        ForeignExchangeRatesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ForeignExchangeRatesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ForeignExchangeRatesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ForeignExchangeRatesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ForeignExchangeRatesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ForeignExchangeRatesResponse(['headers' => null]),
            'result' => new ForeignExchangeRatesResult([]),
        ]);
        ForeignExchangeRatesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ForeignExchangeRatesResultBody::call($ctx);
