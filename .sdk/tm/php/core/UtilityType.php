...
// ForeignExchangeRates SDK utility type

class ForeignExchangeRatesUtility
{
    ...
    public static function copy(ForeignExchangeRatesUtility $src): ForeignExchangeRatesUtility
    {
        $u = new ForeignExchangeRatesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
