...
// ForeignExchangeRates SDK proxy feature
...
class ForeignExchangeRatesProxyFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    public function init(ForeignExchangeRatesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ForeignExchangeRatesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
