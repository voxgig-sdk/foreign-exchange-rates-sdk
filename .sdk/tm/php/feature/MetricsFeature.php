...
// ForeignExchangeRates SDK metrics feature
...
class ForeignExchangeRatesMetricsFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _record(ForeignExchangeRatesContext $ctx, bool $ok): void
    {
