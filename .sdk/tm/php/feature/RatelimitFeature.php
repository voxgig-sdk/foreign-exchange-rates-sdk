...
// ForeignExchangeRates SDK ratelimit feature
...
class ForeignExchangeRatesRatelimitFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _acquire(ForeignExchangeRatesContext $ctx): void
    {
    ...
    private function _track(ForeignExchangeRatesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
