...
// ForeignExchangeRates SDK telemetry feature
...
class ForeignExchangeRatesTelemetryFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _close(ForeignExchangeRatesContext $ctx, bool $ok): void
    {
