...
// ForeignExchangeRates SDK paging feature
...
class ForeignExchangeRatesPagingFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _is_list(ForeignExchangeRatesContext $ctx): bool
    {
