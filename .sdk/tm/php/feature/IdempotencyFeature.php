...
// ForeignExchangeRates SDK idempotency feature
...
class ForeignExchangeRatesIdempotencyFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _mutating(ForeignExchangeRatesContext $ctx): bool
    {
