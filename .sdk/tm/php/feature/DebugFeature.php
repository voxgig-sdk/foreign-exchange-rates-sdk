...
// ForeignExchangeRates SDK debug feature
...
class ForeignExchangeRatesDebugFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _finish(ForeignExchangeRatesContext $ctx, bool $ok): void
    {
