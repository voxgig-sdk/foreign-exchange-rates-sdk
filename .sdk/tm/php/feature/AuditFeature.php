...
// ForeignExchangeRates SDK audit feature
...
class ForeignExchangeRatesAuditFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _emit(ForeignExchangeRatesContext $ctx, string $outcome): void
    {
