...
from projectname_sdk.core.control import ForeignExchangeRatesControl
...
class ForeignExchangeRatesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ForeignExchangeRatesControl()
        ...
        if isinstance(sp, ForeignExchangeRatesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ForeignExchangeRatesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ForeignExchangeRatesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ForeignExchangeRatesOperation({})
        ...
        op = ForeignExchangeRatesOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return ForeignExchangeRatesError(code, msg, self)
