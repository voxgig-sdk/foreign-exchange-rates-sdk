...
class ForeignExchangeRatesTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ForeignExchangeRatesTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ForeignExchangeRatesTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ForeignExchangeRatesTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
