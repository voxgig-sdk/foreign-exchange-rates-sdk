# ForeignExchangeRates SDK feature corpus test
#
...
def _client(kase):
    ...
    ForeignExchangeRatesSDK(...), not ForeignExchangeRatesSDK.test(...): the `test` feature is
    ...
    return ForeignExchangeRatesSDK(opts)
