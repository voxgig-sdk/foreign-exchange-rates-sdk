...
(0, node_test_1.describe)('CurrencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ForeignExchangeRatesSDK({
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'FOREIGN_EXCHANGE_RATES_TEST_CURRENCY_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.ForeignExchangeRatesSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.FOREIGN_EXCHANGE_RATES_APIKEY,
        }));
        let idmap = env['FOREIGN_EXCHANGE_RATES_TEST_CURRENCY_ENTID'];
    ...
    const client = new __1.ForeignExchangeRatesSDK({
        base: 'http://localhost:8080',
