...
(0, node_test_1.describe)('ConvertEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != convert_ref01_data.id);
        // LOAD
        ...
        (0, node_assert_1.default)(convert_ref01_data_dt0.id === convert_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['convert01', 'convert02', 'convert03', 'convert01', 'convert02', 'convert03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
