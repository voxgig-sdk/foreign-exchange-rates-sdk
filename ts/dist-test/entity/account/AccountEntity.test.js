...
(0, node_test_1.describe)('AccountEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set FOREIGN_EXCHANGE_RATES_TEST_ACCOUNT_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['FOREIGN_EXCHANGE_RATES_TEST_ACCOUNT_ENTID'];
    ...
    idmap = env['FOREIGN_EXCHANGE_RATES_TEST_ACCOUNT_ENTID'];
