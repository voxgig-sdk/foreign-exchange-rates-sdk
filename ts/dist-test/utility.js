...
function envOverride(m) {
    if ('TRUE' === process.env.FOREIGN_EXCHANGE_RATES_TEST_LIVE ||
        'TRUE' === process.env.FOREIGN_EXCHANGE_RATES_TEST_OVERRIDE) {
    ...
    m.FOREIGN_EXCHANGE_RATES_TEST_EXPLAIN = process.env.FOREIGN_EXCHANGE_RATES_TEST_EXPLAIN || m.FOREIGN_EXCHANGE_RATES_TEST_EXPLAIN;
    return m;
}
