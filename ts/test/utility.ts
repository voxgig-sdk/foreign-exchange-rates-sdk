...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.FOREIGNEXCHANGERATES_TEST_LIVE ||
    'TRUE' === process.env.FOREIGNEXCHANGERATES_TEST_OVERRIDE
  ) {
  ...
  m.FOREIGNEXCHANGERATES_TEST_EXPLAIN = process.env.FOREIGNEXCHANGERATES_TEST_EXPLAIN || m.FOREIGNEXCHANGERATES_TEST_EXPLAIN
