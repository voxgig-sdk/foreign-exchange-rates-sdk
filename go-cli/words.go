...
func registerSDKWords(r *eng.Registry, client *sdk.ForeignExchangeRatesSDK) {
...
func runOp(client *sdk.ForeignExchangeRatesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
