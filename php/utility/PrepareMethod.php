...
// ForeignExchangeRates SDK utility: prepare_method

class ForeignExchangeRatesPrepareMethod
{
    ...
    public static function call(ForeignExchangeRatesContext $ctx): string
    {
