...
// ForeignExchangeRates SDK utility: fetcher

class ForeignExchangeRatesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ForeignExchangeRatesSDK/1.0)';
    ...
    public static function call(ForeignExchangeRatesContext $ctx, string $fullurl, array $fetchdef): array
    {
