...
// ForeignExchangeRates SDK timeout feature
...
class ForeignExchangeRatesTimeoutFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _with_timeout(ForeignExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ForeignExchangeRatesContext $_ctx, float $ms): void
    {
        $client = $this->client;
