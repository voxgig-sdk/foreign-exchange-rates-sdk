...
// ForeignExchangeRates SDK streaming feature
...
class ForeignExchangeRatesStreamingFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _iterate(ForeignExchangeRatesResult $result): \Generator
    {
    ...
    private function _streamable(ForeignExchangeRatesContext $ctx): bool
    {
