...
// ForeignExchangeRates SDK netsim feature
...
class ForeignExchangeRatesNetsimFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _simulate(ForeignExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ForeignExchangeRatesContext $ctx, array $applied): void
    {
        $client = $this->client;
