...
// ForeignExchangeRates SDK rbac feature
...
class ForeignExchangeRatesRbacFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _required(ForeignExchangeRatesContext $ctx): ?string
    {
    ...
    private function _reject(ForeignExchangeRatesContext $ctx, string $required): void
    {
    ...
    private function _track(ForeignExchangeRatesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
