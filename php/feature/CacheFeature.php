...
// ForeignExchangeRates SDK cache feature
...
class ForeignExchangeRatesCacheFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    private function _through(ForeignExchangeRatesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
