...
// ForeignExchangeRates SDK clienttrack feature
...
class ForeignExchangeRatesClienttrackFeature extends ForeignExchangeRatesBaseFeature
{
    ...
    public function PostConstruct(ForeignExchangeRatesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ForeignExchangeRates-SDK';
