...
// ForeignExchangeRates SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ForeignExchangeRatesSDK::test)
...
{
    private const SDK_CLASS = 'ForeignExchangeRatesSDK';
    ...
    private const SDK_BASE = 'foreignexchangerates_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../foreignexchangerates_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
