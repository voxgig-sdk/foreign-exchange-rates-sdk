...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/foreign-exchange-rates-sdk/releases)),
...
```
lua/
├── foreign-exchange-rates_sdk.lua    -- Main SDK module
...
The main module (`foreign-exchange-rates_sdk`) exports the SDK constructor
