...
function runner.env_override(m)
  local live = runner.getenv("FOREIGN_EXCHANGE_RATES_TEST_LIVE")
  local override = runner.getenv("FOREIGN_EXCHANGE_RATES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOREIGN_EXCHANGE_RATES_TEST_EXPLAIN")
