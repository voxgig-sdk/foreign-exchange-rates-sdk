...
function runner.env_override(m)
  local live = runner.getenv("FOREIGNEXCHANGERATES_TEST_LIVE")
  local override = runner.getenv("FOREIGNEXCHANGERATES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("FOREIGNEXCHANGERATES_TEST_EXPLAIN")
