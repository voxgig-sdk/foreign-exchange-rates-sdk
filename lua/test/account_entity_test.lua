...
describe("AccountEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set FOREIGN_EXCHANGE_RATES_TEST_ACCOUNT_ENTID JSON to run live")
      return
    end
...
function account_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("FOREIGN_EXCHANGE_RATES_TEST_ACCOUNT_ENTID")
