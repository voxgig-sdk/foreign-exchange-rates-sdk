...
local SDK_MODULE = "foreign-exchange-rates_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["account"] = { ["test01"] = { id = "test01" } }, ["convert"] = { ["test01"] = { id = "test01" } }, ["currency"] = { ["test01"] = { id = "test01" } }, ["range"] = { ["test01"] = { id = "test01" } }, ["rate"] = { ["test01"] = { id = "test01" } } } }'
