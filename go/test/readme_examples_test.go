...
const testSeed = `map[string]any{"entity": map[string]any{"account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "convert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "range": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rate": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
