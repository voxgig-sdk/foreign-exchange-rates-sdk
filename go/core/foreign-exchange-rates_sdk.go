...
type ForeignExchangeRatesSDK struct {
	Mode     string
...
func (sdk *ForeignExchangeRatesSDK) OptionsMap() map[string]any {
...
func (sdk *ForeignExchangeRatesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ForeignExchangeRatesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ForeignExchangeRatesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ForeignExchangeRatesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ForeignExchangeRatesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ForeignExchangeRatesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ForeignExchangeRatesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ForeignExchangeRatesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ForeignExchangeRatesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ForeignExchangeRatesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *ForeignExchangeRatesSDK) Account(data map[string]any) ForeignExchangeRatesEntity {
...
func (sdk *ForeignExchangeRatesSDK) Convert(data map[string]any) ForeignExchangeRatesEntity {
...
func (sdk *ForeignExchangeRatesSDK) Currency(data map[string]any) ForeignExchangeRatesEntity {
...
func (sdk *ForeignExchangeRatesSDK) Range(data map[string]any) ForeignExchangeRatesEntity {
...
func (sdk *ForeignExchangeRatesSDK) Rate(data map[string]any) ForeignExchangeRatesEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ForeignExchangeRatesSDK {
	...
	sdk := NewForeignExchangeRatesSDK(sdkopts)
	sdk.Mode = "test"
