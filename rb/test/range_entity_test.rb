...
class RangeEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set FOREIGNEXCHANGERATES_TEST_RANGE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def range_basic_setup(extra)
  ...
  entid_env_raw = ENV["FOREIGNEXCHANGERATES_TEST_RANGE_ENTID"]
