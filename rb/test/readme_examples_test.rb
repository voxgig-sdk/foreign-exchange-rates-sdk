...
#      offline in seeded test mode (ForeignExchangeRatesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ForeignExchangeRates_sdk.rb")
  SDK_CLASS = "ForeignExchangeRatesSDK"
  ...
  SDK_BASE = "ForeignExchangeRates_sdk"
